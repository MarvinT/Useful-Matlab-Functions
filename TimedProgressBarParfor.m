classdef TimedProgressBarParfor < handle
    ...
    %
    % METHODS:  TimedProgressBarParfor(); constructs an object
    ...
    %           p = TimedProgressBarParfor( targetCount, barWidth, ...
    ...
    methods
        ...
        function obj= TimedProgressBarParfor( targetCount, barWidth, waitMsg, ...
    ...
    methods  ( Static )
        ...
        function fname= getFName()
            baseName= 'timedProgressbarParfor_Transient(deleteThis)_';
